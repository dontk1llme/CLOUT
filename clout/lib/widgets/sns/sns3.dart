      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Expanded(
              child: CustomBoxWithImage('assets/images/YouTube.png',
                  customWidth: 90, customHeight: 90),
            ),
          ],
        ),
      ),
...
class CustomBoxWithImage extends StatelessWidget {
  ...
  CustomBoxWithImage(this.imagePath,
      {this.customWidth = 70, this.customHeight = 70});
