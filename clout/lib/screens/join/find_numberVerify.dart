import 'package:clout/screens/join/find_newPassword.dart';
...
class FindNumberVerify extends StatefulWidget {
  const  FindNumberVerify({super.key});

  @override
  State<FindNumberVerify> createState() => _FindNumberVerifyState();
}

class _FindNumberVerifyState extends State<FindNumberVerify>{
  var number;
